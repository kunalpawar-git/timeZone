...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collchangeTimeZoneapse"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="nav barDropdown" role="button"
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-outline-success my-2 my-sm-0" href= "https://www.youtube.com/" target="blank" type="submit"> Search </a>
            </form>
        </div>
    </nav>
<!-- <a href=""></a> -->
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <div class="dropdown show">
                <a class="btn btn-primary btn-lg" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    Browse Times
                </a>

                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="#" onclick="changeTimeZone('America/New_York')">US time</a>
                    <a class="dropdown-item" href="#">EU time</a>
                    <a class="dropdown-item" href="#">Middle East time</a>
                </div>
            </div>
        </div>
    </div>
